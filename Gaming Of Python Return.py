...
class Ship(pg.sprite.Sprite):
    def __init__(self,groups):
        ...
        self.ship = pg.image.load('../Space Shooter Game/sprites/ship.png').convert_alpha()
        self.ship_damaged = pg.image.load('../Space Shooter Game/sprites/damaged ship.png').convert_alpha()
        self.ship_boost =  pg.image.load('../Space Shooter Game/sprites/ship boost.png').convert_alpha()
...
class Laser(pg.sprite.Sprite):
    def __init__(self,groups,pos):
        super().__init__(groups)
        self.image = pg.image.load('../Space Shooter Game/sprites/laser.png').convert_alpha()
...
class Meteor(pg.sprite.Sprite):
    def __init__(self,groups,pos,speed):
        super().__init__(groups)
        meteor_surface = pg.image.load('../Space Shooter Game/sprites/meteorite.png').convert_alpha()
        ...
        self.shattered_meteorite_image = pg.image.load('../Space Shooter Game/sprites/meteorite shatter.png')
        ...
        for rect in self.text_rect:
            if pg.mouse.get_pressed()[0] and rect.collidepoint(mouse_pos):
                ...
                if rect == self.text_rect[0]:
                    speed_meteor = randint(200,300)
                elif rect == self.text_rect[1]:
                    speed_meteor = randint(400,600)
                elif rect == self.text_rect[2]:
                    speed_meteor = randint(700,800)
...
explosion_sfx = pg.mixer.Sound('../Space Shooter Game/Sfx/explosion.wav')
explosion_sfx.set_volume(0.4)

meteor_collision_sfx = pg.mixer.Sound('../Space Shooter Game/sfx/meteor_collision.wav')
meteor_collision_sfx.set_volume(0.4)

laser_sfx = pg.mixer.Sound('../Space Shooter Game/Sfx/laser.wav')
laser_sfx.set_volume(0.2)

ship_boost_sfx =pg.mixer.Sound('../Space Shooter Game/Sfx/ship_boost.wav')
ship_boost_sfx.set_volume(0.1)

retry_sfx = pg.mixer.Sound('../Space Shooter Game/sfx/retry.wav')
retry_sfx.set_volume(0.7)

spacebackgroundmusic ='../Space Shooter Game/Sfx/spacebackgroundmusic.mp3'
